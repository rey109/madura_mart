            ...
            <table class="table align-items-center mb-0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><p class="text-xs font-weight-bold mb-0">{{$data->jenis_barang}}</p></td>
                  <td><p class="text-xs font-weight-bold mb-0">{{$data->stok}}</p></td>
                  <td><p class="text-xs font-weight-bold mb-0">Rp {{number_format($data->harga_jual)}}</p></td>
                </tr>
                @endforeach
              </tbody>
            </table>
