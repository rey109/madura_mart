                        ...
                        <form action="{{ route('sale.update', $data->id) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="no_struk" value="{{ $data->no_struk }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Tanggal Jual</label>
                                    <input type="date" class="form-control" name="tgl_jual" value="{{ $data->tgl_jual }}" required>
                                </div>
